/*
Escribe un programa que permita ingresar un arreglo, los ordene y cuente cuántas veces
aparece un número usando una búsqueda binaria modificada.
*/
#include <iostream>
#include <string>
#include <iomanip>
...
int busquedaBinaria (int arreglo[], int tam, int buscar) {
    int indexL = 0, indexR = tam - 1, contar = 0;
    while (indexL <= indexR) {
